...
public static class SimplePool
{
    ...
    //lay phan tu
    public static T Spawn<T>(PoolType type, [Bridge.Ref] Vector3 pos, [Bridge.Ref] Quaternion rot) where T : GameUnit
    {
...
public class Pool
{
    ...
    //lay phantu tu pool
    public GameUnit Spawn([Bridge.Ref] Vector3 pos, [Bridge.Ref] Quaternion rot)
    {
        GameUnit unit;
