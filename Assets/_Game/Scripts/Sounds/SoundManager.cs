...
public class SoundManager : Singleton<SoundManager>
{
    ...
    public void PlaySound(eAudioName name)
    {
        ...
        if (audioAsset != null && audioAsset.type == eTypeSound.Music && musicprefab == null)
        {
            ...
            musicprefab.audioSource.volume = gameSetting.isMusic ? 1 : 0;
            musicprefab.audioSource.Play();
            musicprefab.audioSource.loop = true;
        }
        else if (audioAsset != null && audioAsset.type == eTypeSound.Music && name != eAudioName.Audio_Music)
        {
            ...
            prefab.audioSource.volume = gameSetting.isMusic ? 1 : 0;
            prefab.audioSource.Play();
            StartCoroutine(WaitDespawnSound(prefab, audioAsset.lenght));
        }
        else if (audioAsset != null && audioAsset.type == eTypeSound.Sound)
        {
